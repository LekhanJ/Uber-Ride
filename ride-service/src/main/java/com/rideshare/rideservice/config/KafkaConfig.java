...
public class KafkaConfig {
    ...
    // Topic where Ride Service publishes ride request. Matching Service subscribes to this topic
    @Bean
    ...
    // Topic where Matching Service publishes match results. Ride Service subscribes to this topic
    @Bean
